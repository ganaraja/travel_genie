...
# Import the actual tool functions from coordinator
...
class TestUserProfileTool:
    ...
    def test_get_user_profile_existing_user(self):
        ...
        response = get_user_profile_tool("user_123")
    ...
    def test_get_user_profile_default_user(self):
        ...
        response = get_user_profile_tool("unknown_user")
...
class TestWeatherTool:
    ...
    def test_get_weather_forecast_basic(self):
        ...
        today = date.today()
        response = get_weather_forecast_tool(
            destination="Maui",
